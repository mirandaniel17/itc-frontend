          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex space-x-4">
                <div className="flex items-center">
                  ...
                  <label
                    ...
                    className="flex items-center cursor-pointer text-gray-600 text-md font-normal whitespace-nowrap"
                  >
              ...
              {formData.payment_type === "MENSUAL" && (
                <div className="mt-4">
                  ...
                  <input
                    ...
                    className="w-full py-2 text-sm tracking-normal border border-gray-300 rounded"
                  />
            ...
            <div className="flex flex-col">
              ...
              <TextInput
                ...
                readOnly
                className="w-full p-3 text-sm tracking-normal bg-gray-100"
              />
            </div>
            ...
            <div className="flex flex-col">
              ...
              <TextInput
                ...
                readOnly
                className="w-full p-3 text-sm tracking-normal mb-5 bg-gray-100"
              />
            </div>
            ...
            {formData.courses.length > 0 && (
              <div className="flex flex-col">
                ...
                <div className="border border-gray-300 rounded-lg p-4 bg-gray-50">
                  ...
                  {formData.payment_type === "MENSUAL" ? (
                    <>
                      <div className="flex justify-between text-md font-bold text-blue-600">
